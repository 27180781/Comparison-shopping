...
⚠️ **קבוצת מחיר ≠ רשת.** לשופרסל טווחי מחיר שונים בין הפורמטים
(שלי / דיל / אקספרס / יש). המפתח הוא `price_group_id`.
**המיפוי נקבע אמפירית ב־Phase 0 מדידה #2.**

⚠️ אם Phase 0 יראה שיותר מ־15% מהמחירים חורגים — המודל הזה לא משתלם.
עבור לשורת מחיר לכל סניף ותכנן ל־ClickHouse מוקדם.
